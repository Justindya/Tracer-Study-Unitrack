    ...
    <div class="bg-white w-full max-w-3xl rounded-3xl shadow-2xl p-8 relative border border-white/50 backdrop-blur-sm">
        ...
        <form method="POST" action="{{ route('register') }}" class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div class="col-span-2 md:col-span-1">
                ...
                <input type="text" name="name" value="{{ old('name') }}" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-50 outline-none transition bg-gray-50 focus:bg-white text-sm" required placeholder="Nama Sesuai Ijazah">
            ...
            <div>
                ...
                <input type="text" name="nim" value="{{ old('nim') }}" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-50 outline-none transition bg-gray-50 focus:bg-white text-sm" required placeholder="Nomor Induk Mahasiswa">
            ...
            <div>
                ...
                <input type="number" name="angkatan" value="{{ old('angkatan') }}" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-50 outline-none transition bg-gray-50 focus:bg-white text-sm" required placeholder="Contoh: 2020">
            </div>

            <div>
                <label class="text-xs font-bold text-gray-600 mb-1 block">Tahun Lulus</label>
                <input type="number" name="tahun_lulus" value="{{ old('tahun_lulus') }}" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-50 outline-none transition bg-gray-50 focus:bg-white text-sm" required placeholder="Contoh: 2024">
            </div>
            ...
            <div class="col-span-2">
                ...
                <textarea name="alamat" rows="2" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-50 outline-none transition bg-gray-50 focus:bg-white text-sm" required placeholder="Alamat domisili saat ini...">{{ old('alamat') }}</textarea>
            </div>
