...
<body class="antialiased text-gray-800 bg-white">
    ...
    <nav class="bg-white py-4 shadow-sm fixed w-full top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                <a href="{{ route('login') }}" class="text-gray-600 hover:text-purple-600 font-medium transition">
                    Masuk
                </a>
                <a href="{{ route('register') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-semibold transition shadow-md">
                    Daftar
                </a>
            </div>
        </div>
    ...
    <header class="relative h-screen flex items-center justify-center text-center px-4 mt-16 bg-gray-900">
        ...
        <div class="relative z-10 max-w-4xl text-white">
            ...
            <a href="{{ route('register') }}" class="bg-white text-blue-600 px-8 py-3 rounded-full font-bold hover:bg-gray-100 transition shadow-lg">
                Mulai Sekarang
            </a>
        </div>
    </header>
    ...
    <section id="fitur" class="py-24">
        <div class="max-w-7xl mx-auto px-4 text-center">
            ...
            <div class="flex flex-col md:flex-row items-center justify-center gap-12">
                ...
                <div class="w-full md:w-1/3">
                    <a href="{{ route('register') }}" class="block bg-blue-500 rounded-2xl p-8 text-white shadow-lg relative overflow-hidden group cursor-pointer hover:bg-blue-600 transition">
    ...
    <section class="bg-blue-600 py-20 text-center text-white">
        <div class="max-w-4xl mx-auto px-4">
            ...
            <a href="{{ route('register') }}" class="bg-white text-blue-600 px-8 py-3 rounded-lg font-bold shadow-lg hover:bg-gray-100 transition">
                Daftar Sekarang
            </a>
        </div>
    </section>
