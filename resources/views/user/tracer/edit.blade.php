                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                <select name="status" id="status" class="w-full px-4 py-3 text-sm font-semibold rounded-xl border border-gray-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none bg-white appearance-none transition cursor-pointer" required>
                                    ...
                                    <option value="melanjutkan_pendidikan" {{ old('status', $normStatus) == 'melanjutkan_pendidikan' ? 'selected' : '' }}>Melanjutkan Pendidikan</option>
                                    <option value="tidak_bekerja" {{ old('status', $normStatus) == 'tidak_bekerja' ? 'selected' : '' }}>Sedang Mencari Pekerjaan</option>
                                </select>
...
<script>
    ...
    window.addEventListener('DOMContentLoaded', function() {
        const status = @json(old('status', $normStatus));
