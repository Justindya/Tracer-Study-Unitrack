<div class="mb-6">
    ...
    <div class="relative">
        <select name="status" id="status" class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none bg-white appearance-none transition cursor-pointer" required>
            ...
            <option value="bekerja" <?php echo e(old('status', $tracer->status ?? '') == 'bekerja' ? 'selected' : ''); ?>>Bekerja</option>
            <option value="wiraswasta" <?php echo e(old('status', $tracer->status ?? '') == 'wiraswasta' ? 'selected' : ''); ?>>Wiraswasta</option>
            <option value="melanjutkan_pendidikan" <?php echo e(old('status', $tracer->status ?? '') == 'melanjutkan_pendidikan' ? 'selected' : ''); ?>>Melanjutkan Pendidikan</option>
            <option value="tidak_bekerja" <?php echo e(old('status', $tracer->status ?? '') == 'tidak_bekerja' ? 'selected' : ''); ?>>Belum Bekerja</option>
        </select>
...
<div class="mb-6">
    ...
    <input type="date" name="tanggal_mulai" id="tanggal_mulai" 
           ...
           value="<?php echo e(old('tanggal_mulai', isset($tracer) ? \Carbon\Carbon::parse($tracer->tanggal_mulai)->format('Y-m-d') : '')); ?>" required>
</div>
...
</script><?php /**PATH C:\xampp\htdocs\Tracer-Study-UniTrack\resources\views/user/tracer/form.blade.php ENDPATH**/ ?>