            ...
            <form action="<?php echo e(route('admin.alumni.store')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <select name="program_studi" class="form-control" required>
                        ...
                        <option value="S1 - Teknik Elerektronika">S1 - Teknik Elerektronika</option>
                        ...
                        <option value="S1 - Teknik Informatika">DIV - Teknik Informatika</option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Tracer-Study-UniTrack\resources\views/admin/alumni_register.blade.php ENDPATH**/ ?>