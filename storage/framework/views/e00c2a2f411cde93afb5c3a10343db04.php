                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden sm:-my-px sm:flex items-center space-x-8">
                            ...
                            <?php else: ?>
                                ...
                                <a href="<?php echo e(route('user.alumni.index')); ?>" class="text-gray-500 hover:text-blue-600 font-medium text-[15px] transition h-full flex items-center <?php echo e((request()->routeIs('user.alumni.index') || request()->routeIs('user.alumni.show')) ? 'border-b-2 border-blue-600 text-blue-600 font-semibold' : ''); ?>">Network</a>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6 gap-4">
                        ...
                        <div class="relative group">
                            ...
                            <div class="absolute right-0 w-48 bg-white rounded-xl shadow-xl py-2 mt-2 hidden group-hover:block hover:block border border-gray-100 origin-top-right z-50">
                                <a href="<?php echo e(route('profile.edit')); ?>" class="block px-4 py-2.5 text-sm <?php echo e(request()->routeIs('profile.*') || request()->routeIs('user.alumni.edit') ? 'text-blue-600 bg-blue-50 font-semibold' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-600'); ?> transition">
