            ...
            <div class="w-full lg:w-1/4">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 text-center sticky top-24">
                    ...
                    <nav class="space-y-1.5 text-left">
                        ...
                        <a href="<?php echo e(route('user.rekomendasi')); ?>" class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-semibold transition bg-blue-50 text-blue-700">
            ...
            container.innerHTML = `
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center flex flex-col items-center">
                    ...
                    <div class="flex flex-col sm:flex-row gap-2">
                        <a href="<?php echo e(route('profile.edit')); ?>" class="bg-white border border-gray-200 text-gray-700 px-5 py-2 rounded-lg font-semibold text-xs hover:bg-gray-50 transition">
                            Update Skill
                        </a>
                        <a href="<?php echo e(route('user.lokers.index')); ?>" class="bg-blue-600 text-white px-5 py-2 rounded-lg font-semibold text-xs hover:bg-blue-700 transition">
                            Eksplor Lowongan
                        </a>
                    </div>
                </div>`;
