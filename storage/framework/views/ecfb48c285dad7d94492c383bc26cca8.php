...
<div id="loker-data" data-jobs="<?php echo e(json_encode($lokers)); ?>" class="hidden"></div>
            ...
            <div class="w-full md:w-1/4">
                <div class="bg-white rounded-xl shadow-sm p-5 text-center sticky top-24 border border-gray-100">
                    ...
                    <div class="space-y-1 text-left">
                        ...
                        <a href="<?php echo e(route('user.rekomendasi')); ?>" class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium transition bg-blue-600 text-white shadow-md shadow-blue-200">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (matchedJobs.length > 0) {
            ...
            matchedJobs.forEach(job => {
                const detailUrl = "<?php echo e(url('/user/lokers')); ?>/" + job.id;
            ...
            container.innerHTML = `
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center flex flex-col items-center">
                    ...
                    <div class="flex gap-3">
                        <a href="<?php echo e(route('profile.edit')); ?>" class="bg-white border border-gray-300 text-gray-700 px-5 py-2 rounded-lg font-bold text-sm hover:bg-gray-50 transition">Update Skill</a>
                        <a href="<?php echo e(route('user.lokers.index')); ?>" class="bg-blue-600 text-white px-5 py-2 rounded-lg font-bold text-sm hover:bg-blue-700 transition shadow-md">Lihat Semua Lowongan</a>
                    </div>
                </div>`;
        }
    });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Tracer-Study-UniTrack\resources\views/user/rekomendasi.blade.php ENDPATH**/ ?>