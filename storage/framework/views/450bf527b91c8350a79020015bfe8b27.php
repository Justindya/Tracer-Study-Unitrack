        ...
        <div class="max-w-4xl mx-auto">
                        ...
                        <div>
                            ...
                            <dl class="space-y-4">
                                <div class="grid grid-cols-3 gap-4">
                                    ...
                                    <dd class="col-span-2 text-sm text-gray-900"><?php echo e($tracer->alumni->nama ?? 'N/A'); ?></dd>
                                </div>
                                <div class="grid grid-cols-3 gap-4">
                                    <dt class="col-span-1 text-sm font-medium text-gray-500">NIM</dt>
                                    <dd class="col-span-2 text-sm text-gray-900"><?php echo e($tracer->alumni->nim ?? 'N/A'); ?></dd>
                                </div>
                                <div class="grid grid-cols-3 gap-4">
                                    <dt class="col-span-1 text-sm font-medium text-gray-500">Email</dt>
                                    <dd class="col-span-2 text-sm text-gray-900 break-all">
                                        <?php echo e($tracer->alumni->email ?? 'N/A'); ?></dd>
                                </div>
                                <div class="grid grid-cols-3 gap-4">
                                    <dt class="col-span-1 text-sm font-medium text-gray-500">Program Studi</dt>
                                    <dd class="col-span-2 text-sm text-gray-900">
                                        <?php echo e($tracer->alumni->program_studi ?? 'N/A'); ?></dd>
                                </div>
                                <div class="grid grid-cols-3 gap-4">
                                    <dt class="col-span-1 text-sm font-medium text-gray-500">Tahun Lulus</dt>
                                    <dd class="col-span-2 text-sm text-gray-900"><?php echo e($tracer->alumni->tahun_lulus ?? 'N/A'); ?>
                        ...
                        <div>
                            ...
                            <dl class="space-y-4">
                                <div class="grid grid-cols-3 gap-4">
                                    ...
                                    <dd class="col-span-2 text-sm text-gray-900 capitalize"><?php echo e($tracer->status); ?></dd>
                                </div>
                                <div class="grid grid-cols-3 gap-4">
                                    <dt class="col-span-1 text-sm font-medium text-gray-500">Tanggal Mulai</dt>
                                    <dd class="col-span-2 text-sm text-gray-900">
                                        <?php echo e($tracer->tanggal_mulai->format('d F Y')); ?></dd>
                                </div>
                            </dl>
                        </div>
                    </div>
            ...
            <?php if($jawaban): ?>
                <div class="bg-white shadow-md rounded-lg overflow-hidden">
                    <div class="px-6 py-4 bg-blue-50 border-b border-blue-100">
                        <h2 class="text-xl font-semibold text-blue-800">Detail <?php echo e(ucwords($status)); ?></h2>
                    </div>
                    <div class="p-6">
                                    ...
                                    <?php $__currentLoopData = $soalLabels[$status]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 whitespace-normal text-sm text-gray-900">
                                                <?php echo e($jawaban->{'soal_' . ($i + 1)} ?? 'N/A'); ?>
            ...
            <?php else: ?>
                <div class="bg-white shadow-md rounded-lg overflow-hidden">
                    <div class="px-6 py-4 bg-yellow-50 border-b border-yellow-100">
                        <h2 class="text-xl font-semibold text-yellow-800">Detail <?php echo e(ucwords($status)); ?></h2>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Tracer-Study-UniTrack\resources\views/admin/tracer_show.blade.php ENDPATH**/ ?>