                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                <select name="status" id="status" class="w-full px-4 py-2 text-sm rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none bg-white appearance-none transition cursor-pointer" required>
                                    ...
                                    <option value="bekerja" <?php echo e(old('status') == 'bekerja' ? 'selected' : ''); ?>>Bekerja (Full Time/Part Time)</option>
                                    <option value="wiraswasta" <?php echo e(old('status') == 'wiraswasta' ? 'selected' : ''); ?>>Wiraswasta / Memiliki Usaha</option>
                                    <option value="melanjutkan_pendidikan" <?php echo e(old('status') == 'melanjutkan_pendidikan' ? 'selected' : ''); ?>>Melanjutkan Pendidikan</option>
                                    <option value="tidak_bekerja" <?php echo e(old('status') == 'tidak_bekerja' ? 'selected' : ''); ?>>Sedang Mencari Pekerjaan</option>
                                </select>
