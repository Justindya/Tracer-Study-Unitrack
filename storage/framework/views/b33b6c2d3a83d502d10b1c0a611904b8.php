            ...
            <div class="flex flex-col md:flex-row gap-5">
                ...
                <div class="w-full md:w-1/4">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 text-center sticky top-20">
                        ...
                        <h2 class="text-base font-bold text-gray-800 truncate"><?php echo e(Auth::user()->name); ?></h2>
                        <p class="text-gray-500 text-[11px] mb-4">Mahasiswa / Alumni</p>

                        <nav class="space-y-1 text-left">
                            <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3 px-3 py-2 rounded-lg text-xs font-medium transition <?php echo e(request()->routeIs('dashboard') ? 'bg-blue-50 text-blue-700 border-l-4 border-blue-600' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
                                <i class="fas fa-home w-4 text-center"></i> Overview
                            </a>
                            <a href="<?php echo e($tracerComplete ? route('user.tracer.index') : route('user.tracer.create')); ?>" class="flex items-center gap-3 px-3 py-2 rounded-lg text-xs font-medium transition text-gray-600 hover:bg-gray-50 hover:text-gray-900">
                                <i class="fas <?php echo e($tracerComplete ? 'fa-check-circle text-green-500' : 'fa-clipboard-list'); ?> w-4 text-center"></i> 
                                <?php echo e($tracerComplete ? 'Data Tracer' : 'Isi Tracer Study'); ?>

                            </a>
                            <a href="<?php echo e(route('user.lamaran.index')); ?>" class="flex items-center gap-3 px-3 py-2 rounded-lg text-xs font-medium transition text-gray-600 hover:bg-gray-50 hover:text-gray-900">
                                <i class="fas fa-briefcase w-4 text-center"></i> Lamaran Saya
                            </a>
                            <a href="<?php echo e(route('user.bookmark.index')); ?>" class="flex items-center gap-3 px-3 py-2 rounded-lg text-xs font-medium transition text-gray-600 hover:bg-gray-50 hover:text-gray-900">
                                <i class="fas fa-heart w-4 text-center"></i> Bookmark
                            </a>
                            <a href="<?php echo e(route('user.rekomendasi')); ?>" class="flex items-center gap-3 px-3 py-2 rounded-lg text-xs font-medium transition text-gray-600 hover:bg-gray-50 hover:text-gray-900">
                ...
                <div class="w-full md:w-3/4 space-y-5">
                    ...
                    <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-xl p-6 text-white shadow-md relative overflow-hidden flex items-center justify-between">
                        <div class="relative z-10">
                            <h1 class="text-xl font-bold mb-1">Halo, <?php echo e(explode(' ', Auth::user()->name)[0]); ?>! 👋</h1>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col justify-center items-center hover:border-blue-200 transition">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <h3 class="text-xl font-bold text-gray-800"><?php echo e($lamaranCount); ?></h3>
                            </div>
                        </div>
                        <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col justify-center items-center hover:border-green-200 transition">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <h3 class="text-xl font-bold text-gray-800"><?php echo e($diterimaCount); ?></h3>
                            </div>
                        </div>
                        <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col justify-center items-center hover:border-yellow-200 transition">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <h3 class="text-xl font-bold text-gray-800"><?php echo e($diprosesCount); ?></h3>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-100 flex flex-col h-full">
                            <div class="flex items-center justify-between mb-4 border-b border-gray-50 pb-2">
                                ...
                                <span class="text-xs font-bold <?php echo e($progress == 100 ? 'text-green-600 bg-green-50' : 'text-blue-600 bg-blue-50'); ?> px-2 py-0.5 rounded"><?php echo e($progress); ?>%</span>
                            </div>
                            ...
                            <div class="space-y-3 flex-1">
                                ...
                                <div class="flex items-center justify-between p-2.5 rounded-lg <?php echo e($bioComplete ? 'bg-gray-50' : 'bg-orange-50 border border-orange-100'); ?>">
                                    <div class="flex items-center gap-3">
                                        <div class="w-5 h-5 rounded-full <?php echo e($bioComplete ? 'bg-green-500' : 'bg-orange-400'); ?> flex items-center justify-center text-white text-[10px]">
                                            <i class="fas <?php echo e($bioComplete ? 'fa-check' : 'fa-user'); ?>"></i>
                                        </div>
                                        <span class="text-xs text-gray-700 font-medium">Biodata Lengkap</span>
                                    </div>
                                    <?php if(!$bioComplete && Auth::user()->alumni): ?>
                                        <a href="<?php echo e(route('user.alumni.edit', Auth::user()->alumni->id)); ?>" class="text-[10px] text-blue-600 hover:underline font-bold">Isi ></a>
                                    <?php endif; ?>
                                </div>

                                <div class="flex items-center justify-between p-2.5 rounded-lg <?php echo e($tracerComplete ? 'bg-gray-50' : 'bg-blue-50 border border-blue-100'); ?>">
                                    <div class="flex items-center gap-3">
                                        <div class="w-5 h-5 rounded-full <?php echo e($tracerComplete ? 'bg-green-500' : 'bg-blue-500'); ?> flex items-center justify-center text-white text-[10px]">
                                            <i class="fas <?php echo e($tracerComplete ? 'fa-check' : 'fa-chart-pie'); ?>"></i>
                                        </div>
                                        <span class="text-xs text-gray-700 font-medium">Tracer Study</span>
                                    </div>
                                    <?php if(!$tracerComplete): ?>
                                        <a href="<?php echo e(route('user.tracer.create')); ?>" class="text-[10px] text-blue-600 hover:underline font-bold">Isi ></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-100 h-full flex flex-col">
                            <div class="flex items-center justify-between mb-4 border-b border-gray-50 pb-2">
                                ...
                                <a href="<?php echo e(route('user.lamaran.index')); ?>" class="text-[10px] text-gray-400 hover:text-blue-600">Semua</a>
                            </div>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $act): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="flex gap-3 group">
                                        <div class="flex flex-col items-center mt-1">
                                            ...
                                            <?php if(!$loop->last): ?><div class="w-px h-full bg-gray-100 my-0.5"></div><?php endif; ?>
                                        </div>
                                        <div class="pb-2 flex-1">
                                            <div class="flex justify-between">
                                                <p class="text-xs font-bold text-gray-800">Lamaran <?php echo e(ucfirst($act->status)); ?></p>
                                                <span class="text-[9px] text-gray-400"><?php echo e($act->created_at->diffForHumans()); ?></span>
                                            </div>
                                            <p class="text-[10px] text-gray-500 truncate max-w-[150px]"><?php echo e($act->loker->judul ?? 'Lowongan'); ?></p>
                                        </div>
                                    </div>
