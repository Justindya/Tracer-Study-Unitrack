...
<div class="bg-gray-50 min-h-screen py-10 font-sans">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form action="<?php echo e(route('user.alumni.index')); ?>" method="GET" class="mb-10 max-w-5xl mx-auto">
                ...
                <div class="w-full md:w-1/3 flex items-center px-4 py-2 bg-gray-50 rounded-xl border border-transparent focus-within:bg-white focus-within:border-blue-300 focus-within:ring-2 focus-within:ring-blue-100 transition">
                    ...
                    <select name="jurusan" class="w-full bg-transparent outline-none text-gray-700 cursor-pointer appearance-none">
                        ...
                        <?php $__currentLoopData = $jurusans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($j); ?>" <?php echo e(request('jurusan') == $j ? 'selected' : ''); ?>><?php echo e($j); ?></option>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 text-center hover:shadow-lg hover:-translate-y-1 transition duration-300 flex flex-col items-center group relative">
                ...
                <a href="<?php echo e(route('user.alumni.show', $a->id)); ?>" class="flex flex-col items-center w-full">
                    <div class="mb-4 relative">
                        <?php if($a->Foto): ?>
                            <img src="<?php echo e(asset('storage/' . $a->Foto)); ?>" alt="<?php echo e($a->nama); ?>" class="w-24 h-24 rounded-full object-cover border-4 border-blue-50 group-hover:border-blue-200 transition shadow-sm">
                        <?php else: ?>
                    ...
                    <h3 class="text-lg font-bold text-gray-900 mb-1 truncate w-full group-hover:text-blue-600 transition"><?php echo e($a->nama); ?></h3>
                    <p class="text-sm text-blue-600 font-medium mb-1 truncate w-full"><?php echo e($a->program_studi); ?></p>
                    <p class="text-xs text-gray-500 mb-4 bg-gray-50 px-2 py-1 rounded-full border border-gray-100">
                        Angkatan <?php echo e($a->angkatan); ?> • Lulus <?php echo e($a->tahun_lulus); ?>

                    </p>
                </a>

                <button onclick="toggleConnect(this, '<?php echo e($a->id); ?>')" 
                        id="btn-connect-<?php echo e($a->id); ?>"
            ...
            <div class="col-span-full text-center py-16 bg-white rounded-3xl border border-dashed border-gray-300">
                ...
                <a href="<?php echo e(route('user.alumni.index')); ?>" class="inline-block mt-4 text-blue-600 font-bold hover:underline text-sm">Reset Pencarian</a>
            </div>
            <?php endif; ?>
        </div>

        <div class="mt-10 flex justify-center">
            <?php echo e($alumni->appends(request()->query())->links()); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Tracer-Study-UniTrack\resources\views/user/alumni_index.blade.php ENDPATH**/ ?>