    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col md:flex-row items-start gap-6 mb-6">
            ...
            <div class="flex gap-3 mt-4 md:mt-0 w-full md:w-auto">
                ...
                <?php else: ?>
                    <a id="btn-apply" href="mailto:<?php echo e($loker->kontak); ?>?subject=Lamaran: <?php echo e($loker->judul); ?>" class="flex-1 md:flex-none bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-xl font-bold transition shadow-md shadow-blue-200 flex items-center justify-center gap-2 text-sm">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
            ...
            btnApply.addEventListener('click', function(e) {
                ...
                fetch('<?php echo e(route("user.lokers.store")); ?>', {
                    ...
                    headers: {
                        ...
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' // Token wajib Laravel
                    },
                    body: JSON.stringify({
                        loker_id: '<?php echo e($loker->id); ?>'
                    })
                })
                .then(res => res.json())
                .then(data => {
        ...
        const jobData = {
            id: "<?php echo e($loker->id); ?>",
            title: "<?php echo e($loker->judul); ?>",
            company: "<?php echo e($loker->perusahaan); ?>",
            url: "<?php echo e(route('user.lokers.show', $loker)); ?>"
        };
