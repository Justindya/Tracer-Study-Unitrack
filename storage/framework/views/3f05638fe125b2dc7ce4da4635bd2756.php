            ...
            <div class="w-full lg:w-1/4">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 text-center sticky top-24">
                    ...
                    <nav class="space-y-1.5 text-left">
                        ...
                        <a href="<?php echo e(route('user.lamaran.index')); ?>" class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-semibold transition bg-blue-50 text-blue-700">
            ...
            <div class="w-full lg:w-3/4 space-y-6">
                        ...
                        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow transition duration-200 flex items-center justify-between gap-4">
                            ...
                            <div class="flex items-center gap-4 min-w-0 flex-1">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="text-xs text-gray-500 font-medium truncate mt-0.5">
                                        <?php echo e($history->loker->perusahaan ?? '-'); ?> &bull; Dilamar <?php echo e($history->created_at->format('d M Y')); ?>
                            ...
                            <div class="flex items-center gap-3 flex-shrink-0">
                                <div class="relative">
                                    ...
                                    <select class="status-updater appearance-none py-1.5 pl-3 pr-7 rounded-lg text-xs font-semibold border capitalize cursor-pointer focus:outline-none focus:ring-1 focus:ring-blue-400 <?php echo e($statusClass); ?>" data-id="<?php echo e($history->loker->id); ?>">
                                        <option value="terkirim" <?php echo e(strtolower($history->status) == 'terkirim' ? 'selected' : ''); ?>>Terkirim</option>
                                        <option value="diproses" <?php echo e(strtolower($history->status) == 'diproses' ? 'selected' : ''); ?>>Diproses / Review</option>
                                        <option value="wawancara" <?php echo e(strtolower($history->status) == 'wawancara' ? 'selected' : ''); ?>>Wawancara</option>
                                        <option value="diterima" <?php echo e(strtolower($history->status) == 'diterima' ? 'selected' : ''); ?>>Diterima</option>
                                        <option value="ditolak" <?php echo e(strtolower($history->status) == 'ditolak' ? 'selected' : ''); ?>>Ditolak</option>
                                    </select>
                                ...
                                <?php if($history->loker): ?>
                                    <a href="<?php echo e(route('user.lokers.show', $history->loker->id)); ?>" class="w-8 h-8 rounded-lg bg-gray-50 border border-gray-200 flex items-center justify-center text-gray-500 hover:bg-blue-50 hover:text-blue-600 transition" title="Lihat Lowongan">
                ...
                <?php else: ?>
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-10 text-center flex flex-col items-center">
                        ...
                        <a href="<?php echo e(route('user.lokers.index')); ?>" class="inline-block bg-blue-600 text-white px-5 py-2 rounded-lg font-semibold text-xs hover:bg-blue-700 transition">
                            Cari Lowongan
                        </a>
                    </div>
                <?php endif; ?>
